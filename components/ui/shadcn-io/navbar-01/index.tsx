  ...
  (
    ...
    return (
      <header
        ref={combinedRef}
        className={cn(
          'sticky top-0 z-50 w-full border-b backdrop-blur bg-gray-200/60 px-4 md:px-6 [&_*]:no-underline rounded-xl mt-8',
          className
        )}
        {...props}
      >
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-6">
              ...
              >
                ...
                <span className="hidden font-bold text-xl sm:inline-block">MobyViewer</span>
              </Link>
              {/* Navigation menu */}
              {!isMobile && (
